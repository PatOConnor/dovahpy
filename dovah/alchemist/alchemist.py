import numpy as np #needed as a dependency for taking screenshots
import cv2          
import pyautogui
import keyboard
...
def gather_inventory(final_item):
    i = 0
    magnify('Skyrim Special Edition')
...
def write_test_to_file(data):
    ...
    file = open("tests/alchemy_lists.py", 'a', encoding="utf-8")
    print('write open...')
    file.write('[\n')
...
def run():
    ...
    print('If you have skyrim open on a separate monitor, you have 5 seconds to '+\
          'click over to it after inputting the last item of your inventory.')
